...
def init_db() -> None:
    ...
    with db_session() as connection:
        ...
        connection.execute("CREATE INDEX IF NOT EXISTS idx_raw_events_attack_subtype ON raw_events (attack_subtype)")
        connection.execute("CREATE INDEX IF NOT EXISTS idx_raw_events_campaign ON raw_events (campaign_id)")
        connection.execute("CREATE INDEX IF NOT EXISTS idx_raw_events_rule_id ON raw_events (rule_id)")
